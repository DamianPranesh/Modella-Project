...
export function SearchResultsDisplay({
  ...
  return (
    <div className="fixed inset-0 bg-white z-50 overflow-y-auto min-h-screen">
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 overflow-y-auto min-h-screen">
