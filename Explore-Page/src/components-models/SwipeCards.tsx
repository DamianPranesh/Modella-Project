...
const cardData: Card[] = [
  {
    ...
    aboutMe:
      "Leading active and lifestyle clothing brand based in Sri Lanka",
    interests: [
      "Fashion Modeling",
      "Runway",
      "Fashion Photography",
  ...
  },
  {
    ...
    aboutMe:
      "Exclusive lines of Makeup right in Sri Lanka",
    interests: [
      "Makeup Artistry",
      "Beauty Trends",
      "Fashion Styling",
  ...
  },
  {
    ...
    aboutMe:
      "Mimosa is a leading women's fashion brand in Sri Lanka",
    interests: [
      "Fashion Design",
      "Sustainable Fashion",
      "Textile Design",
  ...
  },
  {
    ...
    name: "Travlon",
    description:
      "Looking for a swimwear model to represent our brand!",
    aboutMe:
      "leading swimwear brand in Sri Lanka",
    interests: [
      "Fashion Tech",
      "E-commerce Fashion",
      "Digital Fashion",
